...
%----------------------------INPUTS----------------------------------
 ...
 anglC =[u(7) u(8) u(9) u(10) u(11) u(12) u(13) u(14) u(15) u(16)  u(17)];
 lamNf= u(18);

 [fHS, mHS, oMDotMR] = MainRotorFrcMmtFunc(xDotC,omDotC,anglC,lamNf);
 
 % ----------- OUTPUT --------------
 sys(1) = fHS(1); sys(2) = fHS(2); sys(3) = fHS(3);
 sys(4) = mHS(1); sys(5) = mHS(2); sys(6) = mHS(3);
 sys(7) = oMDotMR;
