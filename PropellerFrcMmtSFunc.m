function [sys,x0,str,ts] = PropellerFrcMmtSFunc(t,x,u,flag)
%
...
%----------------------------INPUTS----------------------------------
 ...
 [fPR, mPR] = PropellerFrcMmtFunc(vB, dlt);
 
 % ----------- OUTPUT --------------
 sys(1) = fPR(1); sys(2) = fPR(2); sys(3) = fPR(3);
 sys(4) = mPR(1); sys(5) = mPR(2); sys(6) = mPR(3);
