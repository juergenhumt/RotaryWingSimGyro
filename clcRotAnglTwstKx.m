function [aN, a1, a2, b1, b2, dQ] = clcRotAnglTwstKx(mu, lamNf, thtaN, oMR, rotThrst)
...
%
%
% This module % calculate twist coefficients for rotor blades 
% with offset between elastic% and aerodynamic axis
%
% Input:
...
%
% Output:
%   eNTwst, e1Twst, e2Twst, n1Twst, n2Twst: all twist coefficients used in naca 591
%



global gamRot bTl thta1 aLift dDrgN dDrg1 dDrg2 rRot cMIN
...
[t51,t52,t53,t54,t55,t56,t57,t58,t59,t51N] = clcT5x(mu);

aF = 0.5*bTl^2 - 0.25*mu^2 - dDrg2*t55;
...
bF = thtaN*bTl^3/3 + 2/9/pi*mu^3*thtaN + 0.25*thta1*bTl^4 + mu^4*thta1/32 +...
     ...
     (dDrg1*t52 + dDrg2*(t56*thtaN + t57*(thta1+eNTwst)));
...
cF = aN^2*(0.25*mu^2*bTl^2 - mu^4/16) - mu*aN*b1*bTl^3/3 +...
     ...
     (dDrgN*t51 + dDrg1*(t53*thtaN + t54*(thta1+eNTwst)) +  dDrg2*(t58*thtaN^2+t59*thtaN*(thta1+eNTwst)+t51N*(thta1+eNTwst)^2))+...
     eNTwst*(mu^2*b2*bTl^3/12)+...
